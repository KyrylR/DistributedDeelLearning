package ua.univ.distributeddeellearning.Classification;
...
public class ImageClassification {
	...
	private static final File trainPath = new File("C:\\Users\\inter\\Desktop\\data\\train\\");

	// Data test path -> data will be used to evaluate the model for each iteration during training
	private static final File testPath = new File("C:\\Users\\inter\\Desktop\\data\\test\\");

	// Data evaluation path -> data will be used to evaluate the model after the model has been built
	private static final File evaluationPath = new File("C:\\Users\\inter\\Desktop\\data\\evaluation\\");

	// Model path
	private static final File modelPath = new File("src/main/resources/model/image_classification_model.zip");
